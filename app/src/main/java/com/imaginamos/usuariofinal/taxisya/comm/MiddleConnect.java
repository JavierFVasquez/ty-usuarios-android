...
public class MiddleConnect {
	...
	public static void getService(Context context,String user_id, String latitud, String longitud,String index,String comp1, String comp2 ,
...
//															destination,AsyncHttpResponseHandler responseHandler)
	public static void agend(Context context,String user_id, String uuid,String fecha_hora, int motivo, String address,String Barrio ,String obs,String
